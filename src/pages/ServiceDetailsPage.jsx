    ...
    <>
      {service ? (
        <Paper
          ...
          className="detail"
          sx={{
          position: 'relative', padding: '32px 24px', margin: '120px auto', maxWidth: 800,
        }}
        >
          <IoArrowBackCircle className="back-icon" onClick={() => handleRoute()} />
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={12}>
              ...
              >
                <Avatar alt="" src={vendedor === '' ? defaultProfileImg.src : vendedor.imagen} style={{ marginRight: '14px' }} />
            ...
            <Grid item xs={12} sm={6}>
              <Carousel indicators interval={null}>
                <Carousel.Item>
                  <img alt="" className="d-block w-100" src={service.imagen} />
                </Carousel.Item>
                <Carousel.Item>
                  <img alt="" className="d-block w-100" src={`${service.imagen} slide`} />
                </Carousel.Item>
                <Carousel.Item>
                  <img alt="" className="d-block w-100" src={`${service.imagen} slide`} />
                </Carousel.Item>
              ...
              >
                ...
                >
                  <Avatar
                    ...
                    src={vendedor === '' ? defaultProfileImg.src : vendedor.imagen}
